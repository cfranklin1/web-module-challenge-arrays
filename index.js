...
function is31Flavors(isArray){
    if (isArray.length === 31)  {
        return true
    } else {
        return false
    }
...
function addFlavor(flavorArray, string){
   flavorArray.unshift(string);
...
function getFlavorByIndex(flavorArr, number){
    return flavorArr[number];
}
